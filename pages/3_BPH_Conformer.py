...
def main():
    ...
    #     pywhatkit.sendwhatmsg_instantly('+919072718041','ഹായ് നിങ്ങളുടെ ഫീൽഡിൽ ബിപിഎച്ച് സാന്നിധ്യമുണ്ട്, ദയവായി ആവശ്യമായ നടപടികൾ കൈക്കൊള്ളുകയും കൃഷി ഓഫീസർമാരെ എത്രയും വേഗം അറിയിക്കുകയും ചെയ്യുക',7,tab_close=True)
